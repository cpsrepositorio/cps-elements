...
(() => {
  ...
  window.$docsify.plugins.push(hook => {
    ...
    hook.mounted(() => {
      ...
      searchBox.innerHTML = `
        <cps-input type="search" placeholder="Pesquisar" pill>
          <cps-icon slot="prefix" name="search"></cps-icon>
          <kbd slot="suffix" title="Pressione / para pesquisar">/</kbd>
        </cps-input>
      `;
    ...
    siteSearch.innerHTML = `
      ...
      >
        ...
        <div class="site-search__body">
          ...
          <div class="site-search__empty">Nenhum resultado encontrado.</div>
        </div>
        <footer class="site-search__footer">
          <small><kbd>↑</kbd> <kbd>↓</kbd> navegar</small>
          <small><kbd>↲</kbd> confirmar</small>
          <small><kbd>Esc</kbd> fechar</small>
        </footer>
      </div>
    `;
    ...
    input.addEventListener('cps-input', handleInput);
