...
```jsx react
import { CpsProgress } from '@cgtic-cps/web/react/progress';
...
<script setup>
  ...
  import { CpsProgress } from '@cgtic-cps/web/vue/progress';
  import { CpsButton } from '@cgtic-cps/web/vue/button';
  import { CpsLabel } from '@cgtic-cps/web/vue/label';
