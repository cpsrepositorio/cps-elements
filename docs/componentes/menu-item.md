...
import { CpsMenu } from '@cps/web/react/menu';
import { CpsMenuItem } from '@cps/web/react/menu-item';
import { toast } from '@cps/web/react/notification';
...
```html vue
<script setup>
  import { CpsSeparator } from '@cps/web/components/separator';
  import { CpsMenu } from '@cps/web/components/menu';
  import { CpsMenuItem } from '@cps/web/components/menu-item';
  import { toast } from '@cps/web/components/notification';
