...
import { CpsTabItem } from '@cgtic-cps/web/react/tab-item';
...
```jsx react
import { CpsTabItem } from '@cgtic-cps/web/react/tab-item';
import { CpsTabPanel } from '@cgtic-cps/web/react/tab-panel';
...
<script setup>
  import { ref } from 'vue';
  import { CpsTabItem } from '@cgtic-cps/web/components/tab-item';
