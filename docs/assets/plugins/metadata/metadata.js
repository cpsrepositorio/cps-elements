      ...
      content = content.replace(/\[component-metadata:([a-z-]+)\]/g, (_match, tag) => {
        ...
        if (component.path) {
          ...
          result += `
            ...
            \`\`\`html
            <script type="module" src="https://cdn.jsdelivr.net/npm/@cps/web/${component.path.replace(/\.component/gi, '')}"></script>
            \`\`\`
            </cps-tab-panel>
            ...
            \`\`\`js
            import 'https://cdn.jsdelivr.net/npm/@cps/web/${component.path.replace(/\.component/gi, '')}';
            \`\`\`
            </cps-tab-panel>
            ...
            \`\`\`js
            import { ${component.name} } from '@cps/web/${component.path.replace(/\.component/gi, '').replace('.js', '')}';
            \`\`\`
            </cps-tab-panel>
            ...
            \`\`\`js
            import { ${component.name} } from '@cps/web/${component.path.replace('components/', 'react/').replace(/\.component/gi, '').replace('.js', '')}';
            \`\`\`
            </cps-tab-panel>
            </cps-tab-group>
