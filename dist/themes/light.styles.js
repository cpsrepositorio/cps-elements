...
export default css`
  ...
  .cps-theme-light {
    ...
    --cps-palette-neutral-50: rgb(250 250 250);
    --cps-palette-neutral-100: rgb(245 245 245);
    --cps-palette-neutral-200: rgb(229 229 229);
    --cps-palette-neutral-300: rgb(212 212 212);
    --cps-palette-neutral-400: rgb(163 163 163);
    --cps-palette-neutral-500: rgb(115 115 115);
    --cps-palette-neutral-600: rgb(82 82 82);
    --cps-palette-neutral-700: rgb(64 64 64);
    --cps-palette-neutral-800: rgb(38 38 38);
    --cps-palette-neutral-900: rgb(23 23 23);
    --cps-palette-neutral-950: rgb(11 11 11);
    ...
    --cps-color-system-neutral: rgb(138 138 138);
    --cps-color-system-neutral-transparent: rgb(0 0 0 / 44.58%);
    --cps-color-system-neutral-subtle: rgb(0 0 0 / 2.41%);

    --cps-color-system-informative: rgb(0 95 183);
    --cps-color-system-informative-subtle: rgba(246 246 246 / 50%);
    --cps-color-system-informative-acrylic: linear-gradient(
        rgb(246 246 246 / 90%),
        rgb(246 246 246 / 90%)
      ),
      var(--cps-texture-acrylic);

    --cps-color-system-warning: rgb(157 93 0);
    --cps-color-system-warning-subtle: rgb(255 244 206);
    --cps-color-system-warning-acrylic: linear-gradient(
        rgb(255 244 206 / 90%),
        rgb(255 244 206 / 90%)
      ),
      var(--cps-texture-acrylic);

    --cps-color-system-critical: rgb(196 43 28);
    --cps-color-system-critical-subtle: rgb(253 231 233);
    --cps-color-system-critical-acrylic: linear-gradient(
        rgb(253 231 233 / 90%),
        rgb(253 231 233 / 90%)
      ),
      var(--cps-texture-acrylic);

    --cps-color-system-success: rgb(15 123 15);
    --cps-color-system-success-subtle: rgb(223 246 221);
    --cps-color-system-success-acrylic: linear-gradient(
        rgb(223 246 221 / 90%),
        rgb(223 246 221 / 90%)
      ),
      var(--cps-texture-acrylic);
    ...
    --cps-input-required-content-color: var(--cps-color-system-critical);
  ...
  .cps-toast-stack cps-notification[variant="informative"]::part(base) {
    background: var(--cps-color-system-informative-acrylic);
  }

  .cps-toast-stack cps-notification[variant="warning"]::part(base) {
    background: var(--cps-color-system-warning-acrylic);
  }

  .cps-toast-stack cps-notification[variant="critical"]::part(base) {
    background: var(--cps-color-system-critical-acrylic);
  }

  .cps-toast-stack cps-notification[variant="success"]::part(base) {
    background: var(--cps-color-system-success-acrylic);
  }
`;
