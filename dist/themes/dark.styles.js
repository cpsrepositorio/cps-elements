...
export default css`
  ...
  .cps-theme-dark {
    ...
    --cps-input-background-color: rgb(var(--cps-color-neutral-0));
    --cps-input-background-color-hover: var(--cps-input-background-color);
    --cps-input-background-color-focus: var(--cps-input-background-color);
    --cps-input-background-color-disabled: rgb(var(--cps-color-neutral-100));
    --cps-input-border-color: rgb(var(--cps-color-neutral-300));
    --cps-input-border-color-hover: rgb(var(--cps-color-neutral-400));
    --cps-input-border-color-focus: rgb(var(--cps-color-accent-500));
    --cps-input-border-color-disabled: rgb(var(--cps-color-neutral-300));
    --cps-input-border-width: 1px;
    --cps-input-required-content: "*";
    --cps-input-required-content-offset: -2px;
    --cps-input-required-content-color: var(--cps-input-label-color);

    --cps-input-border-radius-small: var(--cps-border-radius-medium);
    --cps-input-border-radius-medium: var(--cps-border-radius-medium);
    --cps-input-border-radius-large: var(--cps-border-radius-medium);

    --cps-input-font-weight: var(--cps-font-weight-normal);
    --cps-input-font-size-small: var(--cps-font-size-sm);
    --cps-input-font-size-medium: var(--cps-font-size-base);
    --cps-input-font-size-large: var(--cps-font-size-lg);
    --cps-input-letter-spacing: var(--cps-tracking-normal);

    --cps-input-color: rgb(var(--cps-color-neutral-700));
    --cps-input-color-hover: rgb(var(--cps-color-neutral-700));
    --cps-input-color-focus: rgb(var(--cps-color-neutral-700));
    --cps-input-color-disabled: rgb(var(--cps-color-neutral-900));
    --cps-input-icon-color: rgb(var(--cps-color-neutral-500));
    --cps-input-icon-color-hover: rgb(var(--cps-color-neutral-600));
    --cps-input-icon-color-focus: rgb(var(--cps-color-neutral-600));
    --cps-input-placeholder-color: rgb(var(--cps-color-neutral-500));
    --cps-input-placeholder-color-disabled: rgb(var(--cps-color-neutral-600));
    --cps-input-spacing-small: var(--cps-spacing-3);
    --cps-input-spacing-medium: var(--cps-spacing-4);
    --cps-input-spacing-large: var(--cps-spacing-5);

    --cps-input-focus-ring-color: var(--cps-focus-ring-color);
    --cps-input-focus-ring-offset: 0;

    --cps-input-filled-background-color: rgb(var(--cps-color-neutral-100));
    --cps-input-filled-background-color-hover: rgb(
      var(--cps-color-neutral-100)
    );
    --cps-input-filled-background-color-focus: rgb(
      var(--cps-color-neutral-100)
    );
    --cps-input-filled-background-color-disabled: rgb(
      var(--cps-color-neutral-100)
    );
    --cps-input-filled-color: rgb(var(--cps-color-neutral-800));
    --cps-input-filled-color-hover: rgb(var(--cps-color-neutral-800));
    --cps-input-filled-color-focus: rgb(var(--cps-color-neutral-700));
    --cps-input-filled-color-disabled: rgb(var(--cps-color-neutral-800));

    --cps-input-label-font-size-small: var(--cps-font-size-sm);
    --cps-input-label-font-size-medium: var(--cps-font-size-base);
    --cps-input-label-font-size-large: var(--cps-font-size-lg);
    --cps-input-label-color: inherit;

    --cps-input-help-text-font-size-small: var(--cps-font-size-xs);
    --cps-input-help-text-font-size-medium: var(--cps-font-size-sm);
    --cps-input-help-text-font-size-large: var(--cps-font-size-base);
    --cps-input-help-text-color: rgb(var(--cps-color-neutral-500));

    --cps-toggle-size-small: 0.875rem;
    --cps-toggle-size-medium: 1.125rem;
    --cps-toggle-size-large: 1.375rem;

    --cps-overlay-background-color: rgba(0, 0, 0, 0.43);

    --cps-panel-background-color: rgb(var(--cps-color-neutral-50));
    --cps-panel-border-color: rgb(var(--cps-color-neutral-200));
    --cps-panel-border-width: 1px;

    --cps-tooltip-border-radius: var(--cps-border-radius-medium);
    --cps-tooltip-background-color: rgb(var(--cps-color-neutral-800));
    --cps-tooltip-color: rgb(var(--cps-color-neutral-0));
    --cps-tooltip-font-family: var(--cps-font-sans);
    --cps-tooltip-font-weight: var(--cps-font-weight-normal);
    --cps-tooltip-font-size: var(--cps-font-size-sm);
    --cps-tooltip-line-height: var(--cps-leading-snug);
    --cps-tooltip-padding: var(--cps-spacing-1) var(--cps-spacing-2);
    --cps-tooltip-arrow-size: 6px;
