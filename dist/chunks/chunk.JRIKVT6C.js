import{a as $}from"./chunk.GKNG4CXX.js";import{a as h,c as u,d as p}from"./chunk.4OACLEKC.js";import{a as d,c as m}from"./chunk.F7IHQ2QD.js";import{a as H}from"./chunk.2XELF4ZT.js";import{b as T}from"./chunk.KBGGAJDF.js";import{a as l}from"./chunk.SYMZGPTI.js";import{a as g}from"./chunk.4TY62YMM.js";import{a as b,b as o,d as y,e as w}from"./chunk.TL3XP2KZ.js";import{c as r}from"./chunk.FVWYSG5E.js";import{c,e as i}from"./chunk.K3RV6SX6.js";var s=Object.assign(document.createElement("div"),{className:"cps-toast-stack"}),t=class extends w{constructor(){super(...arguments);this.hasSlotController=new H(this,"icon","suffix");this.localize=new T(this);this.open=!1;this.closable=!1;this.variant="neutral";this.icon=!1;this.duration=1/0}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){clearTimeout(this.autoHideTimeout),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration))}handleCloseClick(){this.hide()}handleMouseMove(){this.restartAutoHide()}async handleOpenChange(){if(this.open){this.emit("cps-show"),this.duration<1/0&&this.restartAutoHide(),await u(this.base),this.base.hidden=!1;let{keyframes:a,options:n}=m(this,"notification.show",{dir:this.localize.dir()});await h(this.base,a,n),this.emit("cps-after-show")}else{this.emit("cps-hide"),clearTimeout(this.autoHideTimeout),await u(this.base);let{keyframes:a,options:n}=m(this,"notification.hide",{dir:this.localize.dir()});await h(this.base,a,n),this.base.hidden=!0,this.emit("cps-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,p(this,"cps-after-show")}async hide(){if(this.open)return this.open=!1,p(this,"cps-after-hide")}async toast(){return new Promise(a=>{s.parentElement===null&&document.body.append(s),s.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("cps-after-hide",()=>{s.removeChild(this),a(),s.querySelector("cps-notification")===null&&s.remove()},{once:!0})})}hasIcon(){return this.icon||this.hasSlotController.test("icon")}render(){return r`
      <div
        part="base"
