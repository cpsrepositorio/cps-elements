...
var S2 = class {
  ...
  v(t3) {
    ...
    for (; void 0 !== d3; ) {
      if (l4 === d3.index) {
        let i4;
        2 === d3.type ? i4 = new M(n5, n5.nextSibling, this, t3) : 1 === d3.type ? i4 = new d3.ctor(n5, d3.name, d3.strings, this, t3) : 6 === d3.type && (i4 = new z(n5, this, t3)), this.u.push(i4), d3 = e4[++h3];
      }
...
var M = class {
  constructor(t3, i3, s5, e4) {
    var o5;
    this.type = 2, this._$AH = A, this._$AN = void 0, this._$AA = t3, this._$AB = i3, this._$AM = s5, this.options = e4, this._$Cm = null === (o5 = null == e4 ? void 0 : e4.isConnected) || void 0 === o5 || o5;
  }
  get _$AU() {
    var t3, i3;
  ...
  _$AI(t3, i3 = this) {
    t3 = N(this, t3, i3), u(t3) ? t3 === A || null == t3 || "" === t3 ? (this._$AH !== A && this._$AR(), this._$AH = A) : t3 !== this._$AH && t3 !== T && this.g(t3) : void 0 !== t3._$litType$ ? this.$(t3) : void 0 !== t3.nodeType ? this.T(t3) : v(t3) ? this.k(t3) : this.g(t3);
  }
  S(t3) {
  ...
  g(t3) {
    this._$AH !== A && u(this._$AH) ? this._$AA.nextSibling.data = t3 : this.T(r3.createTextNode(t3)), this._$AH = t3;
  }
  $(t3) {
    var i3;
    ...
    if ((null === (i3 = this._$AH) || void 0 === i3 ? void 0 : i3._$AD) === o5)
      ...
      const t4 = new S2(o5, this), i4 = t4.v(this.options);
  ...
  k(t3) {
    ...
    let s5, e4 = 0;
    for (const o5 of t3)
      e4 === i3.length ? i3.push(s5 = new M(this.S(d2()), this.S(d2()), this, this.options)) : s5 = i3[e4], s5._$AI(o5), e4++;
