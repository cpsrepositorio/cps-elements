import{a as $}from"./chunk.Y7ODPEXI.js";import{a as h,c as u,d as p}from"./chunk.4OACLEKC.js";import{a as d,c as m}from"./chunk.F7IHQ2QD.js";import{a as g}from"./chunk.2XELF4ZT.js";import{b as H}from"./chunk.KBGGAJDF.js";import{a as l}from"./chunk.SYMZGPTI.js";import{a as b}from"./chunk.MIZ6RN32.js";import{a as y,b as o,d as w,e as T}from"./chunk.JOTZQUUG.js";import{a as r}from"./chunk.XKNP6CD6.js";import{c,e as i}from"./chunk.K3RV6SX6.js";var s=Object.assign(document.createElement("div"),{className:"cps-toast-stack"}),t=class extends T{constructor(){super(...arguments);this.hasSlotController=new g(this,"icon","suffix");this.localize=new H(this);this.open=!1;this.closable=!1;this.variant="neutral";this.icon=!1;this.duration=1/0}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){clearTimeout(this.autoHideTimeout),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration))}handleCloseClick(){this.hide()}handleMouseMove(){this.restartAutoHide()}async handleOpenChange(){if(this.open){this.emit("cps-show"),this.duration<1/0&&this.restartAutoHide(),await u(this.base),this.base.hidden=!1;let{keyframes:a,options:n}=m(this,"notification.show",{dir:this.localize.dir()});await h(this.base,a,n),this.emit("cps-after-show")}else{this.emit("cps-hide"),clearTimeout(this.autoHideTimeout),await u(this.base);let{keyframes:a,options:n}=m(this,"notification.hide",{dir:this.localize.dir()});await h(this.base,a,n),this.base.hidden=!0,this.emit("cps-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,p(this,"cps-after-show")}async hide(){if(this.open)return this.open=!1,p(this,"cps-after-hide")}async toast(){return new Promise(a=>{s.parentElement===null&&document.body.append(s),s.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("cps-after-hide",()=>{s.removeChild(this),a(),s.querySelector("cps-notification")===null&&s.remove()},{once:!0})})}hasIcon(){return this.icon||this.hasSlotController.test("icon")}render(){return r`
      <div
        part="base"
        class=${b({notification:!0,"notification--open":this.open,"notification--closable":this.closable,"notification--has-icon":this.hasIcon(),"notification--neutral":this.variant==="neutral","notification--informative":this.variant==="informative","notification--warning":this.variant==="warning","notification--critical":this.variant==="critical","notification--success":this.variant==="success"})}
