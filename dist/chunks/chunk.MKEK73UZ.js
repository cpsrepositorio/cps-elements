import{a as p}from"./chunk.ET7ZNMST.js";import{b as h}from"./chunk.KBGGAJDF.js";import{a as f}from"./chunk.2XELF4ZT.js";import{b as d}from"./chunk.2Y5V6F3T.js";import{a as n}from"./chunk.VBAMGKE2.js";import{a as o,b as l,d as r,e as a}from"./chunk.HZKCC6HR.js";import{c as s,e}from"./chunk.K3RV6SX6.js";var t=class extends a{constructor(){super(...arguments);this.hasSlotController=new f(this,"[default]","prefix","suffix");this.localize=new h(this);this.disabled=!1;this.href="";this.size="body";this.target="_self"}handleClick(i){this.disabled&&(i.preventDefault(),i.stopImmediatePropagation())}handleBlur(){this.emit("cps-blur")}handleFocus(){this.emit("cps-focus")}click(){this.link.click()}focus(i){this.link.focus(i)}blur(){this.link.blur()}render(){return d`
      <a
        part="base"
        href=${this.href}
        target=${this.target}
