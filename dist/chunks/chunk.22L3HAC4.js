            ...
            >
              ...
              ${this.multiple?p`
                    <div part="chips" class="select__chips">
                      ${this.selectedOptions.map((r,c)=>c<this.maxOptionsVisible||this.maxOptionsVisible<=0?p`
                            <cps-chip
                              part="chip"
                              exportparts="
                                base:chip__base,
                          ...
                          `:c===this.maxOptionsVisible?p`
                            <cps-chip part="chip" size=${this.size}> +${this.selectedOptions.length-c} </cps-chip>
                          `:null)}
                    </div>
                  `:""}
