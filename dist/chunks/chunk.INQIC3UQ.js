import{a as T}from"./chunk.XS24VLIC.js";import{a as k}from"./chunk.5H4GFJPQ.js";import{a as y,c as v,d as w}from"./chunk.4OACLEKC.js";import{a as g,c as O}from"./chunk.F7IHQ2QD.js";import{b as _}from"./chunk.KBGGAJDF.js";import{a as E}from"./chunk.OST2O6RI.js";import{a as L}from"./chunk.TBLM4WXU.js";import{b as D}from"./chunk.5DUF7374.js";import{a as m}from"./chunk.SYMZGPTI.js";import{a as I}from"./chunk.2XELF4ZT.js";import{a as b}from"./chunk.4TY62YMM.js";import{a as $,b as n,c,d as u,e as x}from"./chunk.GVOW3L7X.js";import{c as d}from"./chunk.FVWYSG5E.js";import{c as C,e as i}from"./chunk.K3RV6SX6.js";var t=class extends x{constructor(){super(...arguments);this.formControlController=new D(this,{assumeInteractionOn:["cps-blur","cps-input"]});this.hasSlotController=new I(this,"help-text","label");this.localize=new _(this);this.typeToSelectString="";this.hasFocus=!1;this.generatedId="";this.displayLabel="";this.selectedOptions=[];this.id="";this.name="";this.value="";this.defaultValue="";this.size="medium";this.placeholder="";this.multiple=!1;this.maxOptionsVisible=0;this.disabled=!1;this.clearable=!1;this.open=!1;this.strategy="absolute";this.label="";this.placement="bottom";this.helpText="";this.form="";this.required=!1}get validity(){return this.valueInput.validity}get validationMessage(){return this.valueInput.validationMessage}handleIdChange(){this.generatedId=L(this.id)}connectedCallback(){super.connectedCallback(),this.handleDocumentFocusIn=this.handleDocumentFocusIn.bind(this),this.handleDocumentKeyDown=this.handleDocumentKeyDown.bind(this),this.handleDocumentMouseDown=this.handleDocumentMouseDown.bind(this),this.open=!1}addOpenListeners(){document.addEventListener("focusin",this.handleDocumentFocusIn),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown)}removeOpenListeners(){document.removeEventListener("focusin",this.handleDocumentFocusIn),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown)}handleFocus(){this.hasFocus=!0,this.displayInput.setSelectionRange(0,0),this.emit("cps-focus")}handleBlur(){this.hasFocus=!1,this.emit("cps-blur")}handleDocumentFocusIn(e){let s=e.composedPath();this&&!s.includes(this)&&this.hide()}handleDocumentKeyDown(e){let s=e.target,l=s.closest(".select__clear")!==null,o=s.closest("cps-icon-button")!==null;if(l||o)return;if(e.key==="Escape"&&this.open&&(e.preventDefault(),e.stopPropagation(),this.hide(),this.displayInput.focus({preventScroll:!0})),e.key==="Enter"||e.key===" "&&this.typeToSelectString===""){if(e.preventDefault(),e.stopImmediatePropagation(),!this.open){this.show();return}this.currentOption&&!this.currentOption.disabled&&(this.multiple?this.toggleOptionSelection(this.currentOption):this.setSelectedOptions(this.currentOption),this.updateComplete.then(()=>{this.formControlController.updateValidity(!0),this.emit("cps-input"),this.emit("cps-change")}),this.multiple||(this.hide(),this.displayInput.focus({preventScroll:!0})));return}let a=this.getAllOptions().filter(h=>!h.disabled);if(["ArrowUp","ArrowDown","Home","End"].includes(e.key)){if(e.preventDefault(),!this.open&&(this.show(),this.currentOption))return;if(a.length>1){let h=a.indexOf(this.currentOption),r=Math.max(0,h),p=!1;for(;!p;)e.key==="ArrowDown"?(r=h+1,r>a.length-1&&(r=0)):e.key==="ArrowUp"?(r=h-1,r<0&&(r=a.length-1)):e.key==="Home"?r=0:e.key==="End"&&(r=a.length-1),a[r].disabled||(p=!0);this.setCurrentOption(a[r])}}if(e.key.length===1||e.key==="Backspace"){if(e.metaKey||e.ctrlKey||e.altKey)return;if(!this.open){if(e.key==="Backspace")return;this.show()}e.stopPropagation(),e.preventDefault(),clearTimeout(this.typeToSelectTimeout),this.typeToSelectTimeout=window.setTimeout(()=>this.typeToSelectString="",1e3),e.key==="Backspace"?this.typeToSelectString=this.typeToSelectString.slice(0,-1):this.typeToSelectString+=e.key.toLowerCase();for(let h of a)if(h.getTextLabel().toLowerCase().startsWith(this.typeToSelectString)){this.setCurrentOption(h);break}}}handleDocumentMouseDown(e){let s=e.composedPath();this&&!s.includes(this)&&this.hide()}handleComboboxMouseDown(e){let l=e.composedPath().some(o=>o instanceof Element&&o.tagName.toLowerCase()==="cps-icon-button");this.disabled||l||(e.preventDefault(),this.displayInput.focus({preventScroll:!0}),this.open=!this.open)}handleComboboxKeyDown(e){e.stopPropagation(),this.handleDocumentKeyDown(e)}handleClearClick(e){e.stopPropagation(),this.value!==""&&(this.setSelectedOptions([]),this.displayInput.focus({preventScroll:!0}),this.updateComplete.then(()=>{this.formControlController.updateValidity(!0),this.emit("cps-clear"),this.emit("cps-input"),this.emit("cps-change")}))}handleClearMouseDown(e){e.stopPropagation(),e.preventDefault()}handleOptionClick(e){let l=e.target.closest("cps-option"),o=this.value;l&&!l.disabled&&(this.multiple?this.toggleOptionSelection(l):this.setSelectedOptions(l),this.updateComplete.then(()=>this.displayInput.focus({preventScroll:!0})),this.value!==o&&this.updateComplete.then(()=>{this.formControlController.updateValidity(!0),this.emit("cps-input"),this.emit("cps-change",{detail:{option:l}})}),this.multiple||(this.hide(),this.displayInput.focus({preventScroll:!0})))}handleDefaultSlotChange(){let e=this.getAllOptions(),s=this.getAllLabels(),l=Array.isArray(this.value)?this.value:[this.value],o=[];this.multiple&&e.forEach(a=>a.type="checkbox"),s.forEach(a=>{a.size="label",a.variant="secondary"}),customElements.get("cps-option")?(e.forEach(a=>o.push(a.value)),this.setSelectedOptions(e.filter(a=>l.includes(a.value)))):customElements.whenDefined("cps-option").then(()=>this.handleDefaultSlotChange())}handleTagRemove(e,s){e.stopPropagation(),this.disabled||(this.toggleOptionSelection(s,!1),this.updateComplete.then(()=>{this.formControlController.updateValidity(!0),this.emit("cps-input"),this.emit("cps-change")}))}getAllLabels(){return[...this.querySelectorAll("cps-label")]}getAllOptions(){return[...this.querySelectorAll("cps-option")]}getFirstOption(){return this.querySelector("cps-option")}setCurrentOption(e){this.getAllOptions().forEach(l=>{l.current=!1,l.tabIndex=-1}),e&&(this.currentOption=e,e.current=!0,e.tabIndex=0,e.focus())}setSelectedOptions(e){let s=this.getAllOptions(),l=Array.isArray(e)?e:[e];this.multiple?(s.forEach(o=>o.selected=!1),l.length&&l.forEach(o=>o.selected=!0)):(s.forEach(o=>o.selected=!1),l.length&&l.forEach(o=>o.selected=!0)),this.selectionChanged()}toggleOptionSelection(e,s){s!==void 0?e.selected=s:e.selected=!e.selected,this.setCurrentOption(e),this.selectionChanged()}selectionChanged(){var e,s,l,o;this.selectedOptions=this.getAllOptions().filter(a=>a.selected),this.multiple?(this.value=this.selectedOptions.map(a=>a.value),this.placeholder&&this.value.length===0?this.displayLabel="":this.displayLabel=this.localize.term("numOptionsSelected",this.selectedOptions.length)):(this.value=(s=(e=this.selectedOptions[0])==null?void 0:e.value)!=null?s:"",this.displayLabel=(o=(l=this.selectedOptions[0])==null?void 0:l.getTextLabel())!=null?o:""),this.updateComplete.then(()=>{this.formControlController.updateValidity()})}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleDisabledChange(){this.disabled&&(this.open=!1,this.handleOpenChange())}handleValueChange(){let e=this.getAllOptions(),s=Array.isArray(this.value)?this.value:[this.value];this.setSelectedOptions(e.filter(l=>s.includes(l.value)))}async handleOpenChange(){if(this.open&&!this.disabled){this.setCurrentOption(this.selectedOptions[0]||this.getFirstOption()),this.emit("cps-show"),this.addOpenListeners(),await v(this),this.menu.hidden=!1,this.flyout.active=!0,requestAnimationFrame(()=>{this.setCurrentOption(this.currentOption)});let{keyframes:e,options:s}=O(this,"select.show",{dir:this.localize.dir()});await y(this.flyout.container,e,s),this.currentOption&&k(this.currentOption,this.menu,"vertical","auto"),this.emit("cps-after-show")}else{this.emit("cps-hide"),this.removeOpenListeners(),await v(this);let{keyframes:e,options:s}=O(this,"select.hide",{dir:this.localize.dir()});await y(this.flyout.container,e,s),this.menu.hidden=!0,this.flyout.active=!1,this.emit("cps-after-hide")}}async show(){if(this.open||this.disabled){this.open=!1;return}return this.open=!0,w(this,"cps-after-show")}async hide(){if(!this.open||this.disabled){this.open=!1;return}return this.open=!1,w(this,"cps-after-hide")}checkValidity(){return this.valueInput.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.valueInput.reportValidity()}setCustomValidity(e){this.valueInput.setCustomValidity(e),this.formControlController.updateValidity()}focus(e){this.displayInput.focus(e)}blur(){this.displayInput.blur()}render(){let e=this.hasSlotController.test("label"),s=this.hasSlotController.test("help-text"),l=this.label?!0:!!e,o=this.helpText?!0:!!s,a=this.clearable&&!this.disabled&&this.value.length>0,h=this.placeholder&&this.value.length===0;return d`
      <div
        part="form-control"
          ...
          >
            ...
            >
              ...
              <input
                ...
                aria-describedby=${o?`${this.generatedId}-help-text`:void 0}
                role="combobox"
                tabindex="0"
