import{a as $}from"./chunk.GDU6N2ZD.js";import{a as o}from"./chunk.OO3SSE2Z.js";import{a as k}from"./chunk.OST2O6RI.js";import{a as y}from"./chunk.TBLM4WXU.js";import{b as f}from"./chunk.SP7FFJEJ.js";import{a as p}from"./chunk.2XELF4ZT.js";import{a as b}from"./chunk.3TAG5MLH.js";import{a as s}from"./chunk.SYMZGPTI.js";import{a as u}from"./chunk.4TY62YMM.js";import{a as c,b as l,c as n,d as h,e as m}from"./chunk.L6B5EOPQ.js";import{c as a}from"./chunk.FVWYSG5E.js";import{c as d,e as t}from"./chunk.K3RV6SX6.js";var e=class extends m{constructor(){super(...arguments);this.formControlController=new f(this,{value:i=>i.checked?i.value||"on":void 0,defaultValue:i=>i.defaultChecked,setValue:(i,r)=>i.checked=r});this.hasSlotController=new p(this);this.hasFocus=!1;this.generatedId="";this.title="";this.id="";this.name="";this.label="";this.size="medium";this.disabled=!1;this.checked=!1;this.indeterminate=!1;this.defaultChecked=!1;this.form="";this.required=!1}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}handleIdChange(){this.generatedId=y(this.id)}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("cps-change")}handleBlur(){this.hasFocus=!1,this.emit("cps-blur")}handleInput(){this.emit("cps-input")}handleInvalid(i){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(i)}handleFocus(){this.hasFocus=!0,this.emit("cps-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(i){this.input.focus(i)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(i){this.input.setCustomValidity(i),this.formControlController.updateValidity()}render(){let i=this.hasSlotController.test("[default]"),r=this.label?!0:!!i;return a`
    ...
    `}};d(e,"CpsCheckbox"),e.styles=$,t([h('input[type="checkbox"]')],e.prototype,"input",2),t([n()],e.prototype,"hasFocus",2),t([n()],e.prototype,"generatedId",2),t([l()],e.prototype,"title",2),t([l()],e.prototype,"id",2),t([l()],e.prototype,"name",2),t([l()],e.prototype,"value",2),t([l()],e.prototype,"label",2),t([l({reflect:!0})],e.prototype,"size",2),t([l({type:Boolean,reflect:!0})],e.prototype,"disabled",2),t([l({type:Boolean,reflect:!0})],e.prototype,"checked",2),t([l({type:Boolean,reflect:!0})],e.prototype,"indeterminate",2),t([k("checked")],e.prototype,"defaultChecked",2),t([l({reflect:!0})],e.prototype,"form",2),t([l({type:Boolean,reflect:!0})],e.prototype,"required",2),t([s("id")],e.prototype,"handleIdChange",1),t([s("disabled",{waitUntilFirstUpdate:!0})],e.prototype,"handleDisabledChange",1),t([s(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],e.prototype,"handleStateChange",1),e=t([c("cps-checkbox")],e);export{e as a};
