import{a as b}from"./chunk.FN2R745V.js";import{a as p}from"./chunk.2XELF4ZT.js";import{b as m}from"./chunk.KBGGAJDF.js";import{a}from"./chunk.SYMZGPTI.js";import{a as d}from"./chunk.4TY62YMM.js";import{a as r,b as l,d as c,e as n}from"./chunk.F43VYLC4.js";import{c as s}from"./chunk.FVWYSG5E.js";import{c as o,e}from"./chunk.K3RV6SX6.js";var h=0,t=class extends n{constructor(){super(...arguments);this.hasSlotController=new p(this,"[default]","prefix");this.localize=new m(this);this.attrId=++h;this.componentId=`cps-tab-item-${this.attrId}`;this.panel="";this.selected=!1;this.placement="top";this.closable=!1;this.fluid=!1;this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(i){i.stopPropagation(),this.emit("cps-close")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}focus(i){this.tab.focus(i)}blur(){this.tab.blur()}render(){return this.id=this.id.length>0?this.id:this.componentId,s`
      <div
        part="base"
