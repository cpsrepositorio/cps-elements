...
//
const userInteractedControls: WeakSet<BaseFormControl> = new WeakSet();
...
export class FormControlController implements ReactiveController {
  ...
  private doAction(type: 'submit' | 'reset', submitter?: HTMLInputElement | CpsButton) {
    if (this.form) {
  ...
  reset(submitter?: HTMLInputElement | CpsButton) {
    this.doAction('reset', submitter);
  }

  /** Submits the form, triggering validation and form data injection. */
  submit(submitter?: HTMLInputElement | CpsButton) {
