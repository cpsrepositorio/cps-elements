 ...
 * @param {number} timeoutInMs - A timeout in ms. If the timeout has elapsed, the promise rejects
 * @returns A promise which resolves after the scrolling has stopped
 */
export const waitForScrollingToEnd = (element?: Element | null, timeoutInMs: number = 500): Promise<void> => {
