  ...
  describe('validation tests', () => {
    it('should be invalid initially when required and no radio is checked', async () => {
      const radioGroup = await fixture<CpsRadioGroup>(html`
        <cps-radio-group required>
          <cps-radio value="1"></cps-radio>
          <cps-radio value="2"></cps-radio>
        </cps-radio-group>
      `);
    ...
    it(`should be valid when required and one radio is checked`, async () => {
      const el = await fixture<CpsRadioGroup>(html`
        <cps-radio-group label="Select an option" value="1" required>
          <cps-radio name="option" value="1">Option 1</cps-radio>
          <cps-radio name="option" value="2">Option 2</cps-radio>
          <cps-radio name="option" value="3">Option 3</cps-radio>
        </cps-radio-group>
      `);
    ...
    it(`should be invalid when required and no radios are checked`, async () => {
      const el = await fixture<CpsRadioGroup>(html`
        <cps-radio-group label="Select an option" required>
          <cps-radio name="option" value="1">Option 1</cps-radio>
          <cps-radio name="option" value="2">Option 2</cps-radio>
          <cps-radio name="option" value="3">Option 3</cps-radio>
        </cps-radio-group>
    ...
    it(`should be valid when required and a different radio is checked`, async () => {
      const el = await fixture<CpsRadioGroup>(html`
        <cps-radio-group label="Select an option" value="3" required>
          <cps-radio name="option" value="1">Option 1</cps-radio>
          <cps-radio name="option" value="2">Option 2</cps-radio>
          <cps-radio name="option" value="3">Option 3</cps-radio>
        </cps-radio-group>
    ...
    it(`should be invalid when custom validity is set`, async () => {
      const el = await fixture<CpsRadioGroup>(html`
        <cps-radio-group label="Select an option">
          <cps-radio name="option" value="1">Option 1</cps-radio>
          <cps-radio name="option" value="2">Option 2</cps-radio>
          <cps-radio name="option" value="3">Option 3</cps-radio>
        </cps-radio-group>
    ...
    it('should receive the correct validation attributes ("states") when valid', async () => {
      const radioGroup = await fixture<CpsRadioGroup>(html`
        <cps-radio-group value="1" required>
          <cps-radio value="1"></cps-radio>
          <cps-radio value="2"></cps-radio>
        </cps-radio-group>
      `);
      const secondRadio = radioGroup.querySelectorAll('cps-radio')[1];
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      ...
      `);
      const radioGroup = el.querySelector<CpsRadioGroup>('cps-radio-group')!;
      ...
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <cps-radio-group value="1">
            <cps-radio id="radio-1" name="a" value="1"></cps-radio>
            <cps-radio id="radio-2" name="a" value="2"></cps-radio>
          </cps-radio-group>
          <cps-button type="submit">Submit</cps-button>
        </form>
      `);
      const button = form.querySelector('cps-button')!;
      const radioGroup = form.querySelector<CpsRadioGroup>('cps-radio-group')!;
...
describe('when submitting a form', () => {
  it('should submit the correct value when a value is provided', async () => {
    const form = await fixture<HTMLFormElement>(html`
      <form>
        <cps-radio-group name="a" value="1">
          <cps-radio id="radio-1" value="1"></cps-radio>
          <cps-radio id="radio-2" value="2"></cps-radio>
          <cps-radio id="radio-3" value="3"></cps-radio>
        </cps-radio-group>
        <cps-button type="submit">Submit</cps-button>
      </form>
    `);
    const button = form.querySelector('cps-button')!;
    const radio = form.querySelectorAll('cps-radio')[1]!;
  ...
  it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
    const el = await fixture<HTMLFormElement>(html`
      <div>
        ...
        <cps-radio-group form="f" name="a" value="1">
          <cps-radio id="radio-1" value="1"></cps-radio>
          <cps-radio id="radio-2" value="2"></cps-radio>
          <cps-radio id="radio-3" value="3"></cps-radio>
        </cps-radio-group>
...
describe('when a size is applied', () => {
  it('should apply the same size to all radios', async () => {
    const radioGroup = await fixture<CpsRadioGroup>(html`
      <cps-radio-group size="large">
        <cps-radio id="radio-1" value="1"></cps-radio>
        <cps-radio id="radio-2" value="2"></cps-radio>
      </cps-radio-group>
    `);
    const [radio1, radio2] = radioGroup.querySelectorAll('cps-radio')!;

    expect(radio1.size).to.equal('large');
    expect(radio2.size).to.equal('large');
  });

  it('should apply the same size to all toggle buttons', async () => {
    const radioGroup = await fixture<CpsRadioGroup>(html`
      <cps-radio-group size="large">
        <cps-toggle-button id="radio-1" value="1"></cps-toggle-button>
        <cps-toggle-button id="radio-2" value="2"></cps-toggle-button>
      </cps-radio-group>
    `);
    const [radio1, radio2] = radioGroup.querySelectorAll('cps-toggle-button')!;

    expect(radio1.size).to.equal('large');
    expect(radio2.size).to.equal('large');
  });

  it('should update the size of all toggle buttons when size changes', async () => {
    const radioGroup = await fixture<CpsRadioGroup>(html`
      <cps-radio-group size="small">
        <cps-toggle-button id="radio-1" value="1"></cps-toggle-button>
        <cps-toggle-button id="radio-2" value="2"></cps-toggle-button>
      </cps-radio-group>
    `);
...
describe('when the value changes', () => {
  it('should emit cps-change when toggled with the arrow keys', async () => {
    const radioGroup = await fixture<CpsRadioGroup>(html`
      <cps-radio-group>
        <cps-radio id="radio-1" value="1"></cps-radio>
        <cps-radio id="radio-2" value="2"></cps-radio>
    ...
    `);
    const firstRadio = radioGroup.querySelector<CpsRadio>('#radio-1')!;
    const changeHandler = sinon.spy();
    const inputHandler = sinon.spy();

    radioGroup.addEventListener('cps-change', changeHandler);
    radioGroup.addEventListener('cps-input', inputHandler);
    firstRadio.focus();
  ...
  it('should emit cps-change and cps-input when clicked', async () => {
    ...
    `);
    const radio = radioGroup.querySelector<CpsRadio>('#radio-1')!;
    setTimeout(() => radio.click());
    const event = (await oneEvent(radioGroup, 'cps-change')) as CpsChangeEvent;
  ...
  it('should not emit cps-change or cps-input when the value is changed programmatically', async () => {
    ...
    radioGroup.addEventListener('cps-change', () => expect.fail('cps-change should not be emitted'));
    radioGroup.addEventListener('cps-input', () => expect.fail('cps-input should not be emitted'));
    radioGroup.value = '2';
    await radioGroup.updateComplete;
  });

  runFormControlBaseTests('cps-radio-group');
});
