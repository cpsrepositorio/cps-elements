...
const icons = {
  ...
  dismiss: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 9 8"><path d="M4.836 4.566L1.52 7.883A.384.384 0 011.238 8a.4.4 0 01-.289-.113.4.4 0 01-.113-.29c0-.109.039-.202.117-.28L4.27 4 .953.684A.388.388 0 01.836.398a.399.399 0 01.117-.28A.4.4 0 011.238 0c.11 0 .203.04.282.117l3.316 3.317L8.152.117A.388.388 0 018.438 0a.4.4 0 01.281.684L5.402 4 8.72 7.316a.399.399 0 010 .566.399.399 0 01-.281.117.388.388 0 01-.286-.116L4.836 4.566z" fill="currentColor"/></svg>`,
  'dismiss-circle-fill': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12"><path fill="currentColor" d="M6 11A5 5 0 1 0 6 1a5 5 0 0 0 0 10Zm1.854-6.854a.5.5 0 0 1 0 .708L6.707 6l1.147 1.146a.5.5 0 1 1-.708.708L6 6.707L4.854 7.854a.5.5 0 1 1-.708-.708L5.293 6L4.146 4.854a.5.5 0 1 1 .708-.708L6 5.293l1.146-1.147a.5.5 0 0 1 .708 0Z"></path></svg>`,
