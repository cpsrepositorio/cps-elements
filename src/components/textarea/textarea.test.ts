...
describe('<cps-textarea>', () => {
  it('should pass accessibility tests', async () => {
    const el = await fixture<CpsTextarea>(html` <cps-textarea label="Name"></cps-textarea> `);
    await expect(el).to.be.accessible();
  });

  it('default properties', async () => {
    const el = await fixture<CpsTextarea>(html` <cps-textarea></cps-textarea> `);
  ...
  it('should have title if title attribute is set', async () => {
    const el = await fixture<CpsTextarea>(html` <cps-textarea title="Test"></cps-textarea> `);
  ...
  it('should be disabled with the disabled attribute', async () => {
    const el = await fixture<CpsTextarea>(html` <cps-textarea disabled></cps-textarea> `);
  ...
  describe('when the value changes', () => {
    it('should emit cps-change and cps-input when the user types in the textarea', async () => {
      const el = await fixture<CpsTextarea>(html` <cps-textarea></cps-textarea> `);
    ...
    it('should not emit cps-change or cps-input when calling setRangeText()', async () => {
      const el = await fixture<CpsTextarea>(html` <cps-textarea value="hi there"></cps-textarea> `);
  ...
  describe('when using constraint validation', () => {
    ...
    it('should be invalid when required and empty', async () => {
      const el = await fixture<CpsTextarea>(html` <cps-textarea required></cps-textarea> `);

      expect(el.checkValidity()).to.be.false;
    });

    it('should be invalid when required and after removing disabled ', async () => {
      const el = await fixture<CpsTextarea>(html` <cps-textarea disabled required></cps-textarea> `);
    ...
    it('should receive the correct validation attributes ("states") when valid', async () => {
      const el = await fixture<CpsTextarea>(html` <cps-textarea required value="a"></cps-textarea> `);
    ...
    it('should receive validation attributes ("states") even when novalidate is used on the parent form', async () => {
      const el = await fixture<HTMLFormElement>(html` <form novalidate><cps-textarea required></cps-textarea></form> `);
      const textarea = el.querySelector<CpsTextarea>('cps-textarea')!;
  ...
  describe('when submitting a form', () => {
    it('should serialize its name and value with FormData', async () => {
      const form = await fixture<HTMLFormElement>(
        html` <form><cps-textarea name="a" value="1"></cps-textarea></form> `
      );
    ...
    it('should be invalid when setCustomValidity() is called with a non-empty value', async () => {
      const textarea = await fixture<HTMLFormElement>(html` <cps-textarea></cps-textarea> `);
    ...
    it('should be present in form data when using the form attribute and located outside of a <form>', async () => {
      const el = await fixture<HTMLFormElement>(html`
        <div>
          ...
          <cps-textarea form="f" name="a" value="1"></cps-textarea>
        </div>
      `);
  ...
  describe('when resetting a form', () => {
    it('should reset the element to its initial value', async () => {
      const form = await fixture<HTMLFormElement>(html`
        <form>
          <cps-textarea name="a" value="test"></cps-textarea>
          <cps-button type="reset">Reset</cps-button>
        </form>
      `);
      const button = form.querySelector('cps-button')!;
      const textarea = form.querySelector('cps-textarea')!;
      textarea.value = '1234';
  ...
  describe('when using spellcheck', () => {
    ...
    it('should enable spellcheck when set to "true"', async () => {
      const el = await fixture<CpsTextarea>(html` <cps-textarea spellcheck="true"></cps-textarea> `);
      const textarea = el.shadowRoot!.querySelector<HTMLTextAreaElement>('textarea')!;
      expect(textarea.getAttribute('spellcheck')).to.equal('true');
      expect(textarea.spellcheck).to.be.true;
    });
    ...
    it('should disable spellcheck when set to "false"', async () => {
      const el = await fixture<CpsTextarea>(html` <cps-textarea spellcheck="false"></cps-textarea> `);
      const textarea = el.shadowRoot!.querySelector<HTMLTextAreaElement>('textarea')!;
  ...
  runFormControlBaseTests('cps-textarea');
});
